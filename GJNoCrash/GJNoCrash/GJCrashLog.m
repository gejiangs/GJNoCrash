...
static const NSString *GJCrashSeparatorWithFlag = @">>>>>>>>>>>>>>>>>>>>>>>> GJCrashProtector <<<<<<<<<<<<<<<<<<<<<<<<";
...
+ (void)gj_noteErrorWithException:(NSException *)exception attachedTODO:(NSString *)todo {
    ...
    NSString *logErrorMessage = [NSString stringWithFormat:@"\n\n%@\n\n%@\n%@\n%@\n%@\n%@\n",GJCrashSeparatorWithFlag, crashType, errorReason, errorPlace, crashProtector, exception.callStackSymbols];
